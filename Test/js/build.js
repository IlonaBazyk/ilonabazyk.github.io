...
var headers = ["company", "covering", "type", "metal level", "drugs", "primary care visits", "yearly deductible", "price", ""];
var body = [{
	company: 'Insurcom',
	covering: 'Health',
	type: 'PPO',
...
var Rating = function Rating(_ref) {
	var maxRating = _ref.maxRating,
	    rating = _ref.rating;

	var stars = [];
	for (var i = 1; i <= maxRating; i++) {
		stars.push(_react2.default.createElement('span', { key: i, className: i <= rating ? 'ratingOn' : 'ratingOff' }));
	}
...
var Top = function (_Component) {
	...
	function Top(props) {
		...
		_this.handleTable = _this.handleTable.bind(_this);
		_this.handleCard = _this.handleCard.bind(_this);
		return _this;
	}
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('div', { className: 'icon_table', onClick: this.handleTable }),
					_react2.default.createElement('div', { className: 'icon_card', onClick: this.handleCard })
				)
			);
		}
	}]);
...
var TableHeaders = function TableHeaders(_ref2) {
...
var TableBodyItem = function TableBodyItem(_ref3) {
	var body = _ref3.body;
	...
	for (var i = 0; i < body.length; i++) {
		var row = body[i];
		var color = { background: row.color };
		arr.push(_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('img', { src: 'img/' + i + '.png' })
				),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'div',
						{ className: 'rating' },
						_react2.default.createElement(Rating, { rating: row.rating, maxRating: row.maxRating })
					)
				)
			),
			_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				row.type,
				' ',
				_react2.default.createElement('div', { className: 'help' })
			),
			_react2.default.createElement(
				'td',
				null,
				_react2.default.createElement('div', { style: color, className: 'color' }),
				row.metal,
				_react2.default.createElement('div', { className: 'help ml-5' })
			),
			_react2.default.createElement(
				'td',
				null,
...
var Table = function Table(_ref4) {
	...
	return _react2.default.createElement(
		'table',
		{ className: 'Table' },
		_react2.default.createElement(TableHeaders, { headers: headers }),
		_react2.default.createElement(TableBodyItem, { body: body })
	);
};
	...
	for (var i = 0; i < body.length; i++) {
		...
		arr.push(_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'card-item-header flex' },
					_react2.default.createElement('div', { className: 'help mr-5' }),
					header[4]
				),
				_react2.default.createElement(
					'div',
...
var App = function (_Component2) {
	...
	function App(props) {
		...
		_this2.changeCardState = _this2.changeCardState.bind(_this2);
		return _this2;
	}

	_createClass(App, [{
		key: 'changeCardState',
		value: function changeCardState(val) {
			this.setState({
				card: val
			});
		}
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(Top, { changeState: this.changeCardState, card: this.state.card }),
				body
			);
		}
	}]);
...
_reactDom2.default.render(_react2.default.createElement(App, { headers: headers, body: body }), document.getElementById('root'));
